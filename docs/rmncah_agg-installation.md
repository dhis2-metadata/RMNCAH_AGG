# RMNCAH Aggregate Installation Guide { #rmncah-agg-installation }
...
- RMNCAH access (view metadata/view data)
- RMNCAH admin (view and edit metadata/no access to data)
- RMNCAH data capture - (view metadata/capture and view data)
